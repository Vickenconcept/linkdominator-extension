        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-2">
                    <!--div class="col-md-6">
                        <div class="custom-control custom-checkbox custom-control-inline mb-2">
                            <input type="checkbox" class="shadow-none" id="addc-connectPremiumUser">
                            <label class="custom-control-label" for="addc-connectPremiumUser" style="color:black;font-weight:bold;">
                                Connect to with premium members only
                            </label>
                        </div>
                    </div -->
                    <div class="col-md-6">
